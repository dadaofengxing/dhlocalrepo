package com.dh.ddfx.model.entity.house;
...
/**
 * @author duh@elab-plus.com
 * Created by Swing on 2018/6/13.
 */
@ApiModel(description = "楼盘信息")
@Table(name = "house",catalog = "mvp")
public class HouseInfoEntity {

    @Id
    @ApiModelProperty(name = "id", value = "楼盘id")
    private Integer id;
    ...
    @ApiModelProperty(name = "priceUnit", value = "价格单位")
    private String priceUnit;

    @ApiModelProperty(name = "discountPrice", value = "折扣价")
    private Float discountPrice;

    @ApiModelProperty(name = "status", value = "状态 1:在售")
    ...
    @ApiModelProperty(name = "tel", value = "售楼处电话")
    private String tel;
    ...
    @ApiModelProperty(name = "created", value = "创建日期")
    private Date created;

    @ApiModelProperty(name = "updated", value = "更新日期")
